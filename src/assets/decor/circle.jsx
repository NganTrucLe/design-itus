...
function Blue() {
    return (
        ...
        xmlns:xlink="http://www.w3.org/1999/xlink" width="100%">
            <ellipse cx="500.46" cy="400.148" rx="500" ry="400" fill="url(#circle_blue)"/>
            <defs>
            <radialGradient id="circle_blue" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(500 400) rotate(90) scale(398.841 494.001)">
            <stop stop-color="#B6DBF2" stop-opacity="1"/>
            <stop offset="1" stop-color="#B6DBF2" stop-opacity="0"/>
            </radialGradient>
            </defs>
        </svg>
    );
...
function Violet() {
    return (
        <svg viewBox="0 0 1001 800" xmlns="http://www.w3.org/2000/svg" 
        xmlns:xlink="http://www.w3.org/1999/xlink" width="100%">
            <ellipse cx="500.46" cy="400.148" rx="500" ry="400" fill="url(#circle_violet)"/>
            <defs>
            <radialGradient id="circle_violet" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(500 400) rotate(90) scale(398.841 494.001)">
            <stop stop-color="#95ABEC" stop-opacity="0.5"/>
            <stop offset="1" stop-color="#95ABEC" stop-opacity="0"/>
            </radialGradient>
            </defs>
        </svg>
    );
...
function Pink() {
    return (
        <svg viewBox="0 0 1001 800" xmlns="http://www.w3.org/2000/svg" 
        xmlns:xlink="http://www.w3.org/1999/xlink" width="100%">
            <ellipse cx="500.46" cy="400.148" rx="500" ry="400" fill="url(#circle_pink)"/>
            <defs>
            <radialGradient id="circle_pink" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(500 400) rotate(90) scale(398.841 494.001)">
            <stop stop-color="#F1BFDD" stop-opacity="0.8"/>
            <stop offset="1" stop-color="#F1BFDD" stop-opacity="0"/>
            </radialGradient>
            </defs>
        </svg>
    );
...
function Circle(props) {
    ...
    const { type, small, ...other } = props;
    return (
        <SvgIcon {...other} className={[classes.position, small?classes.small:classes.normal].join(" ")} >
            {type=="blue"?<Blue/>:
            (type=="violet"?<Violet/>:
            <Pink/>)}
        </SvgIcon>
...
Circle.propTypes = {
    type: PropTypes.oneOf(["blue","violet","pink"]),
